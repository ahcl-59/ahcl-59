...
Proyecto en la rama principal ***<text style="color: red">retogit</span>*** que contiene un archivo Java.
1) Creación del repositorio main que contiene:
  - Un *ReadMe*
  - Un directorio *src* con el archivo Java
2) Nueva rama de trabajo - se designa la rama ***<text style="color:red">desarrolloPersona</span>*** como rama secundaria.
